...
┃╠✹🔥 ${prefix}report [bug]
┃╚═════════════☬
┗━━❯ ${pushname} ❮━😎`,unicorn, [{"urlButton": {"displayText": "${btn}","url": `${myweb}`}},{"urlButton": {"displayText": "Red Dragon Website🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "�Owner👤","id": 'owner'}}] )
break
...
┃╠✹🔥 ${prefix}delvote
┃╚═════════════☬
┗━━❯ ${pushname} ❮━😎`,unicorn, [{"urlButton": {"displayText": "YouTube📍","url": `${myweb}`}},{"urlButton": {"displayText": "Red Dragon Website🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "�Owner👤","id": 'owner'}}] )
break
case 'rpgmenu':
